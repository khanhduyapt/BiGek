...
int OnInit(void)
  {
   ...
   EventSetTimer(3600); //3600=1h; 1800=30minutes; 900=15minutes; 300=5minutes; 180=3minutes; 60=1minute;
...
void OnTimer(void)
  {
   ...
   FileDelete("Data//ForexH.csv");
   int nfile_handle = FileOpen("Data//ForexH.csv", FILE_READ|FILE_WRITE|FILE_CSV|FILE_ANSI, '\t', CP_UTF8);
