      ...
      if(type== "sell")
        {
         ...
         //m_trade.SellLimit(volume, entry_h4, trade_symbol, stop_loss, 0.0, ORDER_TIME_GTC, expiration, comment + "_12");
        }
         ...
         if(profit < Loss_In_Money)
           {
            ...
            // Khong duoc dung cac lenh nay, rat nguy hiem, vi bi lap lai.
