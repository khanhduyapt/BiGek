...
public class BinanceServiceImpl implements BinanceService {
    ...
    private String analysis_profit(String prifix, String EPIC, String append2, String find_trend) {
        ...
        for (Mt5OpenTradeEntity trade : tradeList) {
            ...
            ea += " SL:" + Utils.appendSpace(Utils.removeLastZero(trade.getStopLoss()), 8);
    ...
    public String initForexTrend(String EPIC, String CAPITAL_TIME_XX) {
        ...
        // TODO: 1. initForexTrend Trên Ma chỉ LONG, dưới Ma chỉ SHORT
        if (CAPITAL_TIME_XX.contains("MINUTE") || Objects.equals(CAPITAL_TIME_XX, Utils.CAPITAL_TIME_H1)) {
            trend_line = Utils.getTrendByHekenAshiList(list);
            trend_by_ma = Utils.isAboveMALine(list, 10) ? Utils.TREND_LONG : Utils.TREND_SHOT;
        ...
        if (heiken_list.size() >= 50) {
            ...
            if (Utils.isBlank(nocation) && CAPITAL_TIME_XX.contains(Utils.CAPITAL_TIME_05)
        ...
        boolean allow_trade_by_ma1_10_20 = false;
        if ((list.size() > 20) && Utils.isNotBlank(switch_trend)) {
        ...
        if (Objects.equals(CAPITAL_TIME_XX, Utils.CAPITAL_TIME_H12)) {
            zone = Utils.getZoneH12(heiken_list);
        } else {
            zone = Utils.getZone(heiken_list);
        }
        ...
        Orders entity = new Orders(orderId, date_time, trend_line, heiken_list.get(0).getCurrPrice(), str_body,
                end_body, sl_long, sl_shot, switch_trend, allow_trade_by_ma1_10_20, trend_by_ma, tradable_zone);
    ...
    public int controlMt5(List<String> CAPITAL_LIST) {
        ...
        for (String EPIC : CAPITAL_LIST) {
            ...
            boolean h1_ma_eq_line = Objects.equals(dto_h1.getTrend_line(), dto_h1.getTrend_by_ma());
            ...
            if (allow_trade && (Utils.EPICS_FOREXS_ALL.contains(EPIC) || Utils.EPICS_CASH_CFD.contains(EPIC)
                ...
                boolean h1_allow_trade_by_ma1_10_20 = (Utils.isNotBlank(dto_h1.getSwitch_trend())
                        && dto_h1.isAllow_trade_by_ma1_10_20());

                boolean h4_allow_trade_by_ma1_10_20 = (Utils.isNotBlank(dto_h4.getSwitch_trend())
                        && dto_h4.isAllow_trade_by_ma1_10_20());

                if (is_trade_zone && d1_ma_eq_line && is_eq_d_h12_h4_h1 && is_eq_h4_h1_15_05 && h1_ma_eq_line
                        && h4_ma_eq_line && Utils.isNotBlank(
                                dto_h4.getSwitch_trend() + dto_h1.getSwitch_trend() + dto_15.getSwitch_trend())) {
                ...
                if (Objects.isNull(trade_dto) && is_trade_zone && is_eq_h4_h1_15_05 && h1_allow_trade_by_ma1_10_20) {
                    String key = EPIC + Utils.CAPITAL_TIME_H1;
                    String append = "1_1020." + Utils.TEXT_PASS;
                ...
                if (Objects.isNull(trade_dto) && is_trade_zone && is_eq_h4_h1_15_05 && h4_allow_trade_by_ma1_10_20) {
                    String key = EPIC + Utils.CAPITAL_TIME_H4;
                    String append = "4_1020." + Utils.TEXT_PASS;
            ...
            // ---------------------------------------------------------------------------------------------
            if ((h1_ma_eq_line && h4_ma_eq_line) || (d1_ma_eq_line && is_eq_d_h12_h4_h1) || is_opening) {
                count += 1;
