...
public class BinanceServiceImpl implements BinanceService {
        ...
        try {
            ...
            while ((line = fin.readLine()) != null) {
                ...
                if (tempArr.length == 16) {
                    ...
                    BigDecimal lower_h1 = Utils.getBigDecimal(tempArr[6]);

                    BigDecimal upper_h4 = Utils.getBigDecimal(tempArr[7]);
                    BigDecimal lower_h4 = Utils.getBigDecimal(tempArr[8]);

                    BigDecimal upper_d1 = Utils.getBigDecimal(tempArr[9]);
                    BigDecimal lower_d1 = Utils.getBigDecimal(tempArr[10]);
                    ...
                    DailyRange daily = new DailyRange(id, trend_w1, w_close, avg_amp_week, upper_h1, lower_h1, upper_h4,
                            lower_h4, upper_d1, lower_d1, d_close, d_today_low, d_today_hig, amp_min_d1, amp_avg_h4);
    ...
    public String initForexTrend(String EPIC, String CAPITAL_TIME_XX) {
        ...
        if (CAPITAL_TIME_XX.contains("MINUTE_")) {
            ...
            trend_by_seq_ma += Utils.trend_by_seq_ma_1_6_10_20(list);
        }
        ...
        Orders entity = new Orders(id, insertTime, trend_of_heiken3_0, current_price, tp_long, tp_shot, close_candle_1,
                ...
                trend_by_ma6_vs_ma20, trend_by_seq_ma, trend_by_bread_area, body_hig_50_candle, body_low_50_candle,
                amplitude_1_part_15, amp_avg_h4, ma06, ma20, ma10, low_50candle, hig_50candle,
    ...
    public int controlMt5(List<String> CAPITAL_LIST) {
        ...
        for (String EPIC : CAPITAL_LIST) {
            ...
            if (CollectionUtils.isEmpty(ranges) || Objects.isNull(dto_w1) || Objects.isNull(dto_d1)
                    ...
                    || Objects.isNull(dto_12) || Objects.isNull(dto_10) || Objects.isNull(dto_03)) {
                String str_null = "";
                ...
                str_null += " 12:" + (Objects.isNull(dto_12) ? "null" : "    ");
                str_null += " 10:" + (Objects.isNull(dto_10) ? "null" : "    ");
            ...
            String trend_d1_ma6 = dto_d1.getTrend_by_ma_06();
            ...
            if (Utils.EPICS_CRYPTO_CFD.contains(EPIC) && !Objects.equals(EPIC, "BTCUSD")) {
                ...
                if (Objects.nonNull(dto_btc_d1)
                    ...
                    if (!Objects.equals(trend_d1_ma6, dto_btc_d1.getTrend_of_heiken3())) {
                        continue;
                    }
                }
            }
            ...
            if (!Objects.equals(trend_w1, trend_d1_ma6)) {
                str_find_trend += "W#D";
            } else {
                str_find_trend += "   ";
            }
            ...
            String find_trend_by_15m = Utils.find_trend_by_15m(dto_15, dto_12, dto_10, dto_03);

            boolean trend_h4h1m15_condition = Objects.equals(find_trend_by_h4, dto_h1.getTrend_of_heiken3())
                    && Objects.equals(find_trend_by_h4, find_trend_by_15m);

            str_find_trend += " D6:" + Utils.appendSpace(trend_d1_ma6, 6);
            str_find_trend += " H4:" + Utils.appendSpace(find_trend_by_h4, 6);
            ...
            String able = "";
            if (Utils.is_able_take_profit_bolliger_min(find_trend_by_15m, dailyRange, curr_price)) {
            ...
            if (Utils.EPICS_STOCKS.contains(EPIC)) {
                ...
                if (Utils.isBlank(trend_d1_ma6) || !Objects.equals(trend_d10, trend_d1_ma6)
                        || !Objects.equals(trend_d10, trend_d1_ma6)) {
            ...
            boolean h1_condition = Objects.equals(find_trend_by_h4, dto_h1.getTrend_of_heiken3())
                    && Objects.equals(find_trend_by_h4, dto_h1.getTrend_by_ma_06())
                    && Objects.equals(find_trend_by_h4, dto_h1.getTrend_by_ma_10());

            boolean has_swt_15x = (dto_10.getSwitch_trend() + dto_12.getSwitch_trend()
                    + dto_15.getSwitch_trend() + dto_d1.getSwitch_trend()).contains(trend_d1);

            boolean has_seq_15x = (dto_10.getTrend_by_seq_ma() + dto_12.getTrend_by_seq_ma()
                    + dto_15.getTrend_by_seq_ma() + dto_d1.getTrend_by_seq_ma()).contains(trend_d1);
            ...
            boolean is_able_tp_min_bb = Utils.is_able_take_profit_bolliger_min(trend_d1, dailyRange,
                    curr_price);
            ...
            if (Utils.isWorkingTime()) {
                if (wd_condition && h1_condition && is_h4_able_to_trade && is_able_tp_min_bb
                        && (trend_h4h1m03_condition || trend_h4h1m15_condition || has_seq_15x || has_swt_15x)) {

                    close_reverse_trade(EPIC, find_trend_by_h4);

                    String comments = "_xuh" + Utils.TEXT_PASS;
                    ...
                    if (total_trade > 0) {
                        dto_notifiy = Utils.calc_Lot_En_SL_TP(EPIC, find_trend_by_h4, curr_price, comments,
                ...
                if (Objects.isNull(dto_notifiy)) {
                    wd_condition = Objects.equals(trend_d1, trend_w1) && Objects.equals(trend_d1, trend_d1_ma6)
                            && Objects.equals(trend_d1, trend_h1);

                    wd_condition |= Objects.equals(trend_d1, trend_w1) && Objects.equals(trend_d1, find_trend_by_h4)
                            && Objects.equals(trend_d1, trend_h1);

                    wd_condition |= Objects.equals(trend_d1, trend_d1_ma6) && Objects.equals(trend_d1, find_trend_by_h4)
                            && Objects.equals(trend_d1, trend_h1);

                    boolean m15x_condition = Objects.equals(trend_d1, dto_15.getTrend_by_ma_06())
                            && Objects.equals(trend_d1, dto_12.getTrend_by_ma_06())
                            && Objects.equals(trend_d1, dto_10.getTrend_by_ma_06())
                            && Objects.equals(trend_d1, dto_03.getTrend_by_ma_06());

                    if (wd_condition && m15x_condition && (has_seq_15x || has_swt_15x) && is_able_tp_min_bb) {
                        ...
                        int total_trade = 1;
                        if (total_trade > 0) {
                            dto_notifiy = Utils.calc_Lot_En_SL_TP(EPIC, trend_d1_ma6, curr_price, comments,
                                    true, Utils.CAPITAL_TIME_15, dailyRange, total_trade);
    ...
    public void closeTrade_by_SL_TP() {
        ...
        for (Mt5OpenTradeEntity trade : mt5Openlist) {
            ...
            if (CollectionUtils.isEmpty(ranges) || Objects.isNull(dto_d1) || Objects.isNull(dto_h4)
                    || Objects.isNull(dto_h1) || Objects.isNull(dto_15)) {
                String str_null = "";
                str_null += "DailyRange:" + (CollectionUtils.isEmpty(ranges) ? "isEmpty" : "       ");
                str_null += " h1:" + (Objects.isNull(dto_h1) ? "null" : "    ");
            ...
            boolean m15_reverse = Objects.equals(dto_15.getTrend_by_ma_06(), REVERSE_TRADE_TREND)
                    && Objects.equals(dto_12.getTrend_by_ma_06(), REVERSE_TRADE_TREND)
                    && Objects.equals(dto_10.getTrend_by_ma_06(), REVERSE_TRADE_TREND)
                    && Objects.equals(dto_03.getTrend_by_ma_06(), REVERSE_TRADE_TREND);

            boolean h1_reverse = Objects.equals(dto_h1.getTrend_by_ma_06(), REVERSE_TRADE_TREND)
                    && Objects.equals(dto_h1.getTrend_of_heiken3(), REVERSE_TRADE_TREND);
            ...
            if ((OPEN_POSITIONS.add(BigDecimal.valueOf(1000)).compareTo(BigDecimal.ZERO) < 0)
                ...
                if (h1_reverse && m15_reverse) {
                    is_hit_sl = true;
                    reason_id += "(open_positions-1000)";
            ...
            if (has_profit && Objects.equals(dto_03.getTrend_by_ma_06(), REVERSE_TRADE_TREND)) {
                if (h1_reverse || m15_reverse || (PROFIT.compareTo(BigDecimal.valueOf(20)) > 0)) {
                    is_hit_sl = true;
                    reason_id += "(has_profit,h1_or_15_or_20$)";
                }

                if (Utils.is_must_close_avoid_overnight_fees_triple()
                        || (PROFIT.compareTo(BigDecimal.valueOf(50)) > 0)) {
                    is_hit_sl = true;
            ...
            if ((PROFIT.add(BigDecimal.valueOf(50)).compareTo(BigDecimal.ZERO) < 0)) {
                ...
                if (opening_list.size() <= 3) {
                    boolean is_price_touches_BB = Utils.is_price_touches_BB_max(TRADING_TREND, dailyRange, curr_price);
                    if (is_price_touches_BB) {
                        total_trade = 2;
                        is_append_trade = true;

                        if (Objects.equals(TRADING_TREND, dto_03.getTrend_by_ma_06())) {
                            total_trade = 3;
                        }
                    }

                    if (PROFIT.add(Utils.RISK_PER_TRADE.multiply(BigDecimal.valueOf(1.8)))
                            .compareTo(BigDecimal.ZERO) < 0) {

                        total_trade = 2;
                        is_append_trade = true;

                        if (PROFIT.add(Utils.RISK_PER_TRADE.multiply(BigDecimal.valueOf(1.9)))
                                .compareTo(BigDecimal.ZERO) < 0) {
                            total_trade = 3;
                        }
                    }
            ...
            if (is_append_trade && (total_trade > 0)) {
                Mt5OpenTrade dto_notifiy = Utils.calc_Lot_En_SL_TP(EPIC, TRADING_TREND, curr_price,
                        "_nhoi" + Utils.TEXT_PASS, true, Utils.CAPITAL_TIME_D1, dailyRange, total_trade);
