...
public class BinanceServiceImpl implements BinanceService {
    ...
    private String analysis(String note, String EPIC, String CAPITAL_TIME_XX, String find_trend) {
        ...
        if (dto.getNote().contains(Utils.TEXT_SWITCH_TREND_BELOW_Ma_LONG)
            ...
            String log = Utils.appendSpace(note, 15) + Utils.appendSpace(dto.getNote(), 15);
        ...
        if (!CollectionUtils.isEmpty(list_all)) {
            ...
            for (Orders dto_h4 : list_all) {
                ...
                if (Objects.nonNull(dto_d1) && Objects.nonNull(dto_h1)) {
                    ...
                    if (Objects.equals(dto_h4.getTrend(), dto_h1.getTrend()) && Utils.isBlank(note)) {
                        String log = Utils.appendSpace(Utils.createLineForex_Header(dto_h4, dto_h4, chart).trim(), 105);
                        log += Utils.appendSpace(Utils.removeLastZero(dto_h4.getCurrent_price()), 15);
                        log += Utils.createLineForex_Body(dto_h4, dto_h4, dto_h4.getTrend()).trim();
                        log += "   " + note + sameSideH4H1;
    ...
    public String initCryptoTrend(String SYMBOL) {
        ...
        if (CRYPTO_LIST_BUYING.contains(SYMBOL) || (Utils.isNotBlank(Utils.switchTrendByHeken01(heken_list_d1))
                && Objects.equals(TREND_D1, Utils.TREND_LONG) && Utils.isBelowMALine(heken_list_d1, 20))) {
        ...
        if (Objects.equals(TREND_D1, Utils.TREND_LONG) && Objects.equals(trend_h4, Utils.TREND_LONG)
                && Utils.isNotBlank(switch_trend) && Utils.isBelowMALine(heken_list_h4, 20)) {
        ...
        if (CRYPTO_LIST_BUYING.contains(SYMBOL) || LIST_WAITING.contains(SYMBOL)) {
    ...
    public void scapForex() {
        ...
        for (String EPIC : CAPITAL_LIST) {
            ...
            if (Objects.equals(trend_d1, trend_h4) && Objects.equals(trend_h4, trend_h1)) {
                // result += analysis("(D1-->H1)", EPIC, Utils.CAPITAL_TIME_HOUR_4, trend_d1);
