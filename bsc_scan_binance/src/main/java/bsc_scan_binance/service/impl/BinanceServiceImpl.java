    ...
    private void alertMsg(String CAPITAL_TIME_XX, List<String> LIST_BUYING, List<String> LIST_SELLING) {
        ...
        for (String EPIC : ARR) {
            ...
            if (!Objects.equals(ACTION, trend)) {
                ...
                String msg = "(Danger)" + Utils.appendSpace(ACTION, 8) + Utils.appendSpace(EPIC, 10)
                        + Utils.appendSpace(Utils.getChartName(dto), 10);
        ...
        if (!CollectionUtils.isEmpty(list_all)) {
            ...
            for (Orders dto_h4 : list_all) {
                ...
                if (Objects.nonNull(dto_d1) && Objects.nonNull(dto_h1) && Objects.nonNull(dto_15)) {
                    ...
                    String note = dto_h4.getNote() + dto_h1.getNote() + dto_15.getNote();

                    if (Objects.equals(dto_h4.getTrend(), dto_h1.getTrend())
                            && Objects.equals(dto_h1.getTrend(), dto_15.getTrend()) && Utils.isNotBlank(note)) {
                    ...
                    // chart = Utils.getChartName(dto_h4) + ":" +
                    // Utils.appendSpace(dto_h4.getTrend(), 8);
                    //
                    // String log = Utils.appendSpace(Utils.createLineForex_Header(dto_h1, dto_h1,
                    // chart).trim(), 105);
                    // log += Utils.appendSpace(Utils.removeLastZero(dto_h1.getCurrent_price()),
                    // 15);
    ...
    public String initCryptoTrend(String SYMBOL) {
        ...
        if (CRYPTO_LIST_BUYING.contains(SYMBOL) || (Objects.equals(trend_h4, Utils.TREND_LONG)
            ...
            if (CRYPTO_LIST_BUYING.contains(SYMBOL)
                    || (Objects.equals(trend_h1, Utils.TREND_LONG) && Utils.isNotBlank(switch_trend))) {
