...
public class BinanceServiceImpl implements BinanceService {
    ...
    public String initForexTrend(String EPIC, String CAPITAL_TIME_XX) {
        ...
        if (heiken_list.size() >= 50) {
            ...
            if (CAPITAL_TIME_XX.contains(Utils.CAPITAL_TIME_05) && Utils.isBlank(nocation)
        ...
        boolean allow_trade_by_ma50 = false;
        if (list.size() > 30) {
            String trend_h4 = get_trend_by_line_chart(EPIC, Utils.CAPITAL_TIME_H4);
            if (Objects.equals(trend_h4, Utils.TREND_LONG) && Objects.equals(nocation, Utils.NOCATION_BELOW_MA50)) {
                allow_trade_by_ma50 = true;
            }
            if (Objects.equals(trend_h4, Utils.TREND_SHOT) && Objects.equals(nocation, Utils.NOCATION_ABOVE_MA50)) {
                allow_trade_by_ma50 = true;
            }
        }
        // -----------------------------DATABASE---------------------------
        ...
        Orders entity = new Orders(orderId, date_time, trend_line, heiken_list.get(0).getCurrPrice(), str_body,
                end_body, sl_long, sl_shot, switch_trend, allow_trade_by_ma50, trend_heiken, tradable_zone);
    ...
    public int controlMt5(List<String> CAPITAL_LIST) {
        ...
        for (String EPIC : CAPITAL_LIST) {
            ...
            if (allow_trade && (Utils.EPICS_FOREXS_ALL.contains(EPIC) || Utils.EPICS_CASH_CFD.contains(EPIC)
                ...
                if (Objects.isNull(trade_h4) && is_candidate && m05_allow_trade && m15_allow_trade && is_sweet_trend) {
                    String key = EPIC + Utils.CAPITAL_TIME_H4;
                    String append = "962412_040105";
    ...
    public void closeTrade_by_SL_TP() {
        ...
        for (Mt5OpenTradeEntity trade : mt5Openlist) {
            ...
            if (is_reverse_h4 && !Objects.equals(dto_h4.getTrend_line(), TRADE_TREND)
                    && !Objects.equals(dto_h1.getTrend_line(), TRADE_TREND)
                    && !Objects.equals(dto_15.getTrend_line(), TRADE_TREND)
                    && !Objects.equals(dto_05.getTrend_line(), TRADE_TREND)) {
