...
public class BinanceServiceImpl implements BinanceService {
    ...
    public void createReport() {
        ...
        if (!CollectionUtils.isEmpty(list_d1)) {
            ...
            for (Orders dto_d1 : list_d1) {
                ...
                String log = Utils.createLineForex_Header(dto_d1, dto_d1, Utils.appendSpace(
                        dto_d1.getNote().substring(0, dto_d1.getNote().length() > 40 ? 40 : dto_d1.getNote().length()),
                        40));
    ...
    public String initForexTrend(String EPIC, String CAPITAL_TIME_XX) {
        ...
        String switch_trend_type = Utils.switchTrendType(list); // ma36.10, HekenAshi, ma012
        ...
        Orders entity = new Orders(orderId, date_time, trend_ma3, list.get(0).getCurrPrice(), str_body_price,
                end_body_price, sl_long, sl_shot, switch_trend_type);
        ordersRepository.save(entity);
