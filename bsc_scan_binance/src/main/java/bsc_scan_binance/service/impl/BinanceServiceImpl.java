...
public class BinanceServiceImpl implements BinanceService {
    ...
    private void outputLog(String prefix_id, String EPIC, Orders dto_entry, Orders dto_sl, String append,
        ...
        if (Utils.isNotBlank(grand_trend)) {
            log += Utils.appendSpace(Utils.calc_BUF_LO_HI_BUF_Forex(risk_x5, false, grand_trend, EPIC, dto_d1, dto_d1),
                    63);
        } else {
            log += Utils.appendSpace("", 63);
        }
    ...
    public String controlMt5(List<String> CAPITAL_LIST) {
        ...
        for (String EPIC : CAPITAL_LIST) {
            ...
            if (Objects.equals(trend_h12, Utils.TREND_LONG)
                    && Objects.equals(dto_h12.getNocation(), Utils.NOCATION_BELOW_MA50)) {
            ...
            if (Objects.equals(trend_h4, Utils.TREND_SHOT)
                    && Objects.equals(dto_h4.getNocation(), Utils.NOCATION_ABOVE_MA50)) {
                h4_allow_trade = true;
            }
            ...
            if ((Utils.EPICS_FOREXS_ALL.contains(EPIC) || Utils.EPICS_CASH_CFD.contains(EPIC)
                ...
                if (Objects.equals(trend_w1, trend_d1) && Objects.equals(trend_d1, trend_h12)
                    ...
                    if (Objects.isNull(dto) && (h1_allow_trade || m15_allow_trade)
                            && (h12_allow_trade || h4_allow_trade) && Objects.equals(trend_h12, trend_h4)
