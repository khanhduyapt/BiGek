...
public class BinanceServiceImpl implements BinanceService {
    ...
    private String getTimeframes(String EPIC) {
        ...
        for (String CAPITAL_TIME_XX : times) {
            ...
            result += chart_name + ":";
            result += Objects.equals(trend_xx, Utils.TREND_LONG) ? "Buy "
        ...
        String action = "";
        boolean has_trade_not_eq_d1 = false;
        ...
        if (has_trade_not_eq_d1) {
            result += " " + Utils.appendSpace(action.trim(), 4) + "#d1 ->Stop ";
        } else if (has_trade_not_eq_h12) {
            result += " " + Utils.appendSpace(action.trim(), 4) + "#h12->Stop ";
        } else {
            result += "                ";
        }
            ...
            if ((Utils.EPICS_FOREXS_ALL.contains(EPIC) || Utils.EPICS_CASH_CFD.contains(EPIC)
                ...
                if (Objects.equals(trend_w1, trend_d1)) {
                    if (Objects.equals(trend_d1, trend_h12) && Objects.equals(trend_d1, trend_h4)) {
                        ...
                        if (m15_allow_trade && dto_h4.isAllow_trade_by_ma50()
                                && dto_w1.getSwitch_trend().contains(trend_w1)
                                && dto_w1.getTrend_zone().contains(trend_w1)) {
                        ...
                        if (m15_allow_trade && dto_h4.isAllow_trade_by_ma50() && switch_trend_d1.contains(trend_d1)) {
                        ...
                        if (m15_allow_trade && dto_h4.isAllow_trade_by_ma50() && switch_trend_h12.contains(trend_d1)) {
                        ...
                        if (m15_allow_trade && dto_h4.isAllow_trade_by_ma50() && switch_trend_h4.contains(trend_d1)) {
                        ...
                        if (m15_allow_trade && dto_h1.isAllow_trade_by_ma50() && dto_h4.isAllow_trade_by_ma50()) {
                ...
                if (!is_opening_trade(EPIC, "")) {
                    if (m15_allow_trade && dto_h4.isAllow_trade_by_ma50() && !Objects.equals(trend_w1, trend_d1)
                            && dto_h12.getSwitch_trend().contains(trend_d1) && Objects.equals(trend_d1, trend_h12)
        ...
        try {
            ...
            for (Mt5OpenTrade dto : BscScanBinanceApplication.mt5_open_trade_List) {
                ...
                if (trade_count < MAX_TRADE) {
                    ...
                    if (!Utils.isSleepTime_23h_to_8h() && !is_opening_trade(EPIC, "")) {
    ...
    public void closeTrade_by_SL_TP() {
        ...
        for (Mt5OpenTradeEntity trade : mt5Openlist) {
            ...
            if ((Utils.CAPITAL_TIME_H4 + Utils.CAPITAL_TIME_H1 + Utils.CAPITAL_TIME_15)
                    .contains(mt5Entity.getTimeframe()) && !Objects.equals(trend_h4, TRADE_TREND)
            ...
            if ((PROFIT.compareTo(Utils.RISK_0_10_PERCENT) > 0) && !Objects.equals(trend_h4, TRADE_TREND)
                    && !Objects.equals(trend_h1, TRADE_TREND)) {
                isPriceHit_TP = true;
            }
            // ---------------------------------------------------------------------------------
