...
public class BinanceServiceImpl implements BinanceService {
    ...
    private String analysis_profit(String prifix, String EPIC, String append2, String find_trend) {
        ...
        for (Mt5OpenTradeEntity trade : tradeList) {
            ...
            ea += "     Profit:"
                    ...
                    + "$    ";
            ea += Utils.appendLeft(Utils.getStringValue(Utils.formatPrice(trade.getVolume(), 2)), 11)
                    + "(lot)";
            ea += Utils.appendSpace("", 7);
    ...
    private void outputLog(String EPIC, String append, String trend_fi) {
        ...
        BigDecimal risk = Utils.RISK_0_02_PERCENT;

        String log_week = "     0.1% " + Utils.appendSpace(Utils.calc_BUF_LO_HI_BUF_Forex(Utils.RISK_0_02_PERCENT,
        ...
        if (is_opening_trade(EPIC, "") || !dto_d1.isTradable_zone() || !dto_h4.isTradable_zone()
    ...
    public void monitorProfit() {
        ...
        for (String company : Utils.COMPANIES) {
            ...
            String risk_0_15 = "     Risk: 0.1% : " + Utils.RISK_0_02_PERCENT.intValue() + "$ per trade";
        ...
        if (!CollectionUtils.isEmpty(list_all)) {
            ...
            for (Orders dto_d1 : list_all) {
                ...
                if (Objects.equals(trend_w1, trend_d1)) {
                    ...
                    log += Utils.createLineForex_Body(Utils.RISK_0_02_PERCENT, dto_d1, dto_d1, trend_w1, true).trim();
                    list_d1_log.add(log);
                    index += 1;
                }
            }
    ...
    public String initCryptoTrend(String SYMBOL) {
        ...
        // ------------------------------------------------------------------
        String switch_trend = Utils.switchTrendByMa1vs8910(heiken_list_h4);
    ...
    public void scapStocks() {
        ...
        for (String EPIC : Utils.EPICS_STOCKS) {
            ...
            if (Objects.equals(trend_d1, trend_mo) && Objects.equals(trend_d1, trend_w1)
            ...
            if (is_opening_trade(EPIC, "")) {
                ...
                if (is_eq_mo_w_d_h4_h1 && dto_d1.isTradable_zone()
                    ...
                    if (((Utils.EPICS_STOCKS_EUR.contains(EPIC) && Utils.is_london_session())
                        ...
                        String append = "96.24w.";
                        append += Utils.TEXT_PASS;

                        Mt5OpenTrade trade_h4 = Utils.calc_Lot_En_SL_TP(Utils.RISK_0_02_PERCENT, EPIC, trend_d1, dto_h1,
    ...
    public void initTradeList() {
        ...
        for (Mt5DataTrade trade : tradeList) {
            ...
            // ----------------------------------------------------------------------------------
            Orders dto_sl = ordersRepository.findById(EPIC + "_" + Utils.CAPITAL_TIME_15).orElse(null);
    ...
    public int controlMt5(List<String> CAPITAL_LIST) {
        ...
        for (String EPIC : CAPITAL_LIST) {
            ...
            eoz += (!dto_w1.isTradable_zone() && Objects.equals(trend_d1, trend_w1)) ? "W1" : "--";
            eoz += (!dto_d1.isTradable_zone()) ? "D1" : "--";
            eoz += (!dto_12.isTradable_zone() && Objects.equals(trend_d1, trend_12)) ? "H12" : "---";
            eoz += (!dto_h4.isTradable_zone() && Objects.equals(trend_d1, trend_h4)) ? "H4" : "--";
            ...
            if (Objects.equals(trend_d1, trend_12) && dto_12.getSwitch_trend().contains(dto_12.getTrend_by_ma10())) {
            ...
            if (Objects.isNull(trade_dto) && is_eq_d_h12_h4_h1 && is_eq_h4_h1_15_05 && is_trade_zone_m15) {
                ...
                trade_dto = Utils.calc_Lot_En_SL_TP(Utils.RISK_0_02_PERCENT, EPIC, trend_h4, dto_15, dto_15, append,
            ...
            if (Objects.nonNull(trade_dto)) {
                ...
                if (allow_padding_trade_after_1day(EPIC)) {
                    msg += "padding_trade_after_1day(" + EPIC + ")";
                }
            ...
            // ---------------------------------------------------------------------------------------------
            if (dto_15.isAllow_trade_by_ma1_6_10_50() || is_opening_trade(EPIC, "")) {
                count += 1;
    ...
    public void closeTrade_by_SL_TP() {
        ...
        for (Mt5OpenTradeEntity trade : mt5Openlist) {
            ...
            if (Objects.isNull(dto_h1) || Objects.isNull(dto_15) || Objects.isNull(dto_05)) {
                ...
                String m05 = "05:" + (Objects.isNull(dto_15) ? "null" : "    ");
                Utils.logWritelnDraft(
                        String.format("[controlMt5] dto (%s):  %s, %s, %s.", Utils.appendSpace(EPIC, 10), h1, m15,
                                m05));
            ...
            if (PROFIT.compareTo(Utils.RISK_0_05_PERCENT) > 0) {
                if (Objects.equals(dto_h1.getTrend_line(), REVERSE_TRADE_TREND)
                        ...
                        && Objects.equals(dto_05.getTrend_by_ma10(), REVERSE_TRADE_TREND)) {

                    take_profit = true;
                }
            }
            // ---------------------------------------------------------------------------------
            boolean m15_reverse = false;
            if (Objects.equals(dto_15.getTrend_by_ma10(), REVERSE_TRADE_TREND)
            ...
            if (allow_close_trade_after(TICKET, Utils.MINUTES_OF_30M)) {
                if (take_profit || m15_reverse || is_hit_sl) {
                    String reason = "";
                    ...
                    if (m15_reverse || is_hit_sl || take_profit) {
