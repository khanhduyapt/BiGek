...
public class BinanceServiceImpl implements BinanceService {
    ...
    public String sendMsgKillLongShort(String gecko_id, String symbol) {
        ...
        String switch_trend = Utils.switchTrend(list_15m);
    ...
    public String initCrypto(String gecko_id, String symbol) {
        ...
        // ---------------------------------------------------------
        String position = "";
        if (Objects.equals(Utils.TEXT_TREND_No1_MA34568, Utils.switchTrend(list_h4))) {
            position = "_PositionH4";
        }
        if (Objects.equals(Utils.TEXT_TREND_No1_MA34568, Utils.switchTrend(list_days))) {
    ...
    public String initCryptoTrend(String TIME, String symbol) {
        ...
        Orders entity = new Orders(orderId, date_time, trend_i0, cur_price, en_long, en_shot, sl_long, sl_shot,
                switch_trend);
        ...
        if (isH1 && Utils.isNotBlank(switch_trend)
            ...
            if (Objects.equals(entity_d1.getTrend(), entity_h4.getTrend())
                    && Objects.equals(entity_h4.getTrend(), trend_i0)) {

                String log = Utils
                        .appendSpace(
                                "(HekenAshi)  " + Utils.getChartName(list) + Utils.appendSpace(symbol, 10) + " ("
                                        + trend_i0 + ")" + Utils.appendLeft(list.get(0).getCurrPrice().toString(), 10),
                                60)
        ...
        if (Objects.equals(Utils.CRYPTO_TIME_1D, TIME) && Objects.equals(Utils.TREND_LONG, trend_i0)) {
            String dataType = Objects.equals(Utils.TREND_LONG, trend_i0) ? "L" : "S";
            PrepareOrders his = new PrepareOrders(his_id, orderId, trend_i0, dataType);
    ...
    public String scapForex15M(String EPIC) {
        ...
        List<BtcFutures> list_3 = getCapitalData(EPIC, Utils.CAPITAL_TIME_MINUTE_3);

        String switch_trend_5 = Utils.switchTrendByMa(list_5, true);
        String switch_trend_3 = Utils.switchTrendByMa(list_3, true);

        String trend_5 = Utils.isUptrendByMaIndex(list_5, 3) ? Utils.TREND_LONG : Utils.TREND_SHORT;
        String trend_3 = Utils.isUptrendByMaIndex(list_3, 3) ? Utils.TREND_LONG : Utils.TREND_SHORT;

        if ((Utils.isNotBlank(switch_trend_5) || Utils.isNotBlank(switch_trend_3))
                && (Objects.equals(dto_h4.getTrend(), trend_5) || Objects.equals(dto_h4.getTrend(), trend_3))) {

            String log = Utils.appendSpace(EPIC, 15);
            log += "(H4:" + Utils.appendSpace(dto_h4.getTrend(), 4) + ")   ";
            log += "(05:" + Utils.appendSpace(switch_trend_5, 4) + ")   ";
            log += "(03:" + Utils.appendSpace(switch_trend_3, 4) + ")   ";
    ...
    public void createReport() {
        ...
        if (!CollectionUtils.isEmpty(list_all_d1)) {
            ...
            for (Orders dto_d1 : list_all_d1) {
                ...
                Orders dto_h4 = ordersRepository.findById(EPIC + "_" + Utils.CAPITAL_TIME_HOUR_4).orElse(null);
                String log = Utils.createLineForex(dto_h4, dto_h4);
    ...
    public String initForexTrend(String EPIC, String CAPITAL_TIME_XXX) {
        ...
        if (isH4) {
            // sl_long = sl_long.subtract(bread);
