...
public class BinanceServiceImpl implements BinanceService {
    ...
    public String sendMsgKillLongShort(String gecko_id, String symbol) {
        ...
        String switch_trend = Utils.switchTrend_6_10_20(list);
        ...
        if (!CollectionUtils.isEmpty(list_d1)) {
            ...
            for (Orders dto_d1 : list_d1) {
                ...
                String log = Utils.appendSpace(
                        Utils.createLineForex_Header(dto_d1, dto_d1, Utils.appendSpace(dto_d1.getNote(), 10)).trim(),
                        110) + "   ";
    ...
    public String scapForex(String EPIC, String CAPITAL_TIME_XX) {
        ...
        if (Utils.isNotBlank(switch_trend_by_ma)) {
            note += "Ma6->10->20:" + Utils.appendSpace(switch_trend_by_ma, 15);
        }
        ...
        if (Utils.isNotBlank(switch_trend_by_ma)) {
            ...
            List<BtcFutures> list_h4 = getCapitalData(EPIC, Utils.CAPITAL_TIME_HOUR_4);
            if ((Utils.isUptrendByMa(list_h4, 1, 0, 1) != Utils.isUptrendByMa(list_h1, 3, 0, 1))) {
                return "";
            }
